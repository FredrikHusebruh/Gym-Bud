...
export default function GetStarted() {
    ...
    return (
       <div className='flex flex-col items-center rounded-3xl justify-start bg-[#131313] gap-2 h-auto w-full  border border-[#272727] overflow-hidden m-4 p-2'>
            ...
            <button onClick={() => navigate("/Workout")} className='p-2 w-full h-full rounded-full font-extrabold italic text-xl bg-[#3E25F6] text-[#F3F3F3]'>Get started now</button>
        </div>
    )
}
